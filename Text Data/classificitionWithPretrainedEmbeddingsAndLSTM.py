...
# Based on some kind of analysis (please refer to the book p:141-143 to understand how we choose this number)
vocab_size = 13200
...
Plot.plot_history_line('Epochs', 'Accuracy', train_acc, 'accuracy',
                       val_acc, 'val_accuracy', figure_name='PretrainedEmbdAndLSTMAcc.png')

# Plot the train vs val loss chart
Plot.plot_history_line('Epochs', 'Loss', train_loss, 'loss', val_loss,
                       'val_loss', figure_name='PretrainedEmbdAndLSTMLoss.png')
