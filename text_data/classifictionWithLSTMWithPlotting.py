...
model = tf.keras.Sequential([ 
    ...
    tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(16)), # Rule of thump : embedding dim == LSTM units count
...
Plot.plot_history_line('Epochs', 'Accuracy', train_acc, 'accuracy', val_acc, 'val_accuracy', figure_name='LSTMAccuracy.png')

# Plot the train vs val loss chart
Plot.plot_history_line('Epochs', 'Loss', train_loss, 'loss', val_loss, 'val_loss', figure_name='LSTMLoss.png')