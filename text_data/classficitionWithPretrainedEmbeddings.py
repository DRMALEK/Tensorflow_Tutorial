...
hub_layer = hub.KerasLayer(
    "https://tfhub.dev/google/tf2-preview/gnews-swivel-20dim/1",     # Use a pretrained Embedding
    output_shape=[20], 
    input_shape=[], 
    dtype=tf.string, 
    trainable=False
...
model.fit(x=np.array(training_padded), y=np.array(training_labels), validation_data=(np.array(testing_padded), np.array(testing_labels)))
